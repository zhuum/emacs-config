...
;; not sure how to remap tab to indent, "M-i" & "M-o" are the defaults
;; (define-key evil-insert-state-map (kbd "<tab>") 'evil-jump-forward)
;; (define-key evil-insert-state-map (kbd "S-<tab>") 'evil-jump-backward)
